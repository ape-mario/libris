export default {
  ...
  'add.quick': 'Quick',
  'add.quick.add': 'Add & Next',
  'add.quick.count': '{count} books added',
  'add.quick.added': 'Added: {title}',
  'add.quick.hint': 'Other details (publisher, category, etc.) can be filled in later from the book page.',
  ...
  'add.barcode_not_found_search': 'ISBN not found. Try searching by book title.',
  ...
  'toast.book_updated': 'Book updated',
  ...
  // Scanner
  'scanner.live_scan': 'Live Scan',
  'scanner.live_scan_desc': 'Point camera at barcode in real-time',
  'scanner.stop_camera': 'Close Camera',
  'scanner.camera_error': 'Failed to open camera. Try photo or type manually.',
  'scanner.no_barcode': 'No barcode detected. Make sure the barcode is clearly visible.',
  'scanner.take_photo': 'Photo Barcode',
  'scanner.take_photo_desc': 'Take a photo of the barcode',
  'scanner.from_gallery': 'Choose from gallery',
  'scanner.from_gallery_desc': 'Use an existing barcode photo',
  'scanner.type_isbn': 'Type ISBN',
  'scanner.type_isbn_desc': 'Enter the ISBN number from the back of the book',
  ...
  'onboarding.barcode_not_found_title': 'Book not found',
  'onboarding.barcode_not_found_desc': 'Barcode detected but book is not in the database. Try another book or add manually later.',
  'onboarding.barcode_not_found_search': 'Barcode detected but not in the database. Try searching by title:',
  'onboarding.no_barcode_title': 'Barcode not detected',
  'onboarding.no_barcode_desc': 'Make sure the barcode is clearly visible in the photo. Try again closer.',
