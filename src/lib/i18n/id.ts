export default {
  ...
  'add.quick': 'Cepat',
  'add.quick.add': 'Tambah & Lanjut',
  'add.quick.count': '{count} buku ditambahkan',
  'add.quick.added': 'Ditambahkan: {title}',
  'add.quick.hint': 'Detail lain (penerbit, kategori, dll) bisa diisi nanti dari halaman buku.',
  ...
  'add.barcode_not_found_search': 'ISBN tidak ditemukan. Coba cari berdasarkan judul buku.',
  ...
  'toast.book_updated': 'Buku diperbarui',
  ...
  // Scanner
  'scanner.live_scan': 'Scan Langsung',
  'scanner.live_scan_desc': 'Arahkan kamera ke barcode secara langsung',
  'scanner.stop_camera': 'Tutup Kamera',
  'scanner.camera_error': 'Gagal membuka kamera. Coba foto atau ketik manual.',
  'scanner.no_barcode': 'Barcode tidak terdeteksi. Pastikan barcode terlihat jelas.',
  'scanner.take_photo': 'Foto Barcode',
  'scanner.take_photo_desc': 'Ambil foto barcode pakai kamera',
  'scanner.from_gallery': 'Pilih dari galeri',
  'scanner.from_gallery_desc': 'Gunakan foto barcode yang sudah ada',
  'scanner.type_isbn': 'Ketik ISBN',
  'scanner.type_isbn_desc': 'Masukkan nomor ISBN dari belakang buku',
  ...
  'onboarding.barcode_not_found_title': 'Buku tidak ditemukan',
  'onboarding.barcode_not_found_desc': 'Barcode terbaca tapi buku tidak ada di database. Coba buku lain atau tambah manual nanti.',
  'onboarding.barcode_not_found_search': 'Barcode terbaca tapi buku tidak ada di database. Coba cari berdasarkan judul:',
  'onboarding.no_barcode_title': 'Barcode tidak terdeteksi',
  'onboarding.no_barcode_desc': 'Pastikan barcode terlihat jelas di foto. Coba foto ulang lebih dekat.',
  'onboarding.try_again': 'Coba lagi',
